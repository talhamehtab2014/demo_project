...
class NetworkCallImp implements NetworkCall {
  ...
  void _initializeInterceptor() {
    _dio.interceptors.addAll([_prettyDioLogger, TokenInterceptors(_dio)]);
  }
  ...
  Future<Response<dynamic>> onPost({
    ...
    return _makeRequest(() => _dio.post(api, data: data), api, 'POST');
  }
  ...
  Future<Response<dynamic>> onPut({
    ...
    return _makeRequest(() => _dio.put(api, data: data), api, 'PUT');
  }
  ...
  Future<Response<dynamic>> onPatch({
    ...
    return _makeRequest(() => _dio.patch(api, data: data), api, 'PATCH');
  }
  ...
  Future<Response<dynamic>> onGet({
    ...
    return _makeRequest(() => _dio.get(api), api, 'GET');
  }
  ...
  Future<Response<dynamic>> onDelete({
    ...
    return _makeRequest(() => _dio.delete(api), api, 'DELETE');
  }
